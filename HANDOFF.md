...
| פעולה | שלב | provider | יעד |
|---|---|---|---|
| בחירת מלונות | 6 (שני התרחישים) | `zite` | `wnzocgbazy.zite.so/?id=…` |
| שינוי זמן פגישת ייעוץ | 3 | `fillout` | טופס `tuqZnYRAxeus` |
| משוב | 10 | `fillout` | טופס `vYY9mWeMQsus` |
| מילוי טופס שינויים | 4 | `make-webhook` | **חסום בקוד** — ראו אזהרה |
